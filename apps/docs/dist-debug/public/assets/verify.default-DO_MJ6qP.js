...
import "./_Cov2JroK.js";
//#region src/tags/verify/default/scroll-area/default.marko
...
_content_resume("dE0", "<div class=p-4><h4 class=\"mb-4 text-sm leading-none font-medium\">Tags</h4><!></div>", "Db%", $ScrollArea_content__setup$1);
//#endregion
//#region src/tags/verify/default/scroll-area/horizontal.marko
...
_content_resume("eE0", "<div class=\"flex w-max space-x-4 p-4\"></div>", " ", $ScrollArea_content__setup);
//#endregion
//#region dist-debug/.marko-run/verify.default.scroll-area.client-entry.marko
init();
//#endregion
