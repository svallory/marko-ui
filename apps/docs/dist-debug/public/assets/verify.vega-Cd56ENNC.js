...
//#region src/tags/verify/vega/tree-view/controlled-selection.marko
var FILE_TREE = [
	{
		id: "src",
		label: "src",
...
_resume("NAb0", $selectedValueChange);
//#endregion
//#region dist-debug/.marko-run/verify.vega.tree-view.client-entry.marko
init();
//#endregion
