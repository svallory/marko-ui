...
//#region ../../packages/shadcn/ui/field/field-group.marko
var $template = "<div><!></div>";
var $walks = " D%l";
var $setup = () => {};
var $content_direct = /*@__PURE__*/ _dynamic_tag_content(1);
var $input_class__OR__rest__script = _script("kAyzXM9", ($scope) => _attrs_script($scope, "a"));
var $input_class__OR__rest = /*@__PURE__*/ _or(7, ($scope) => {
	_attrs($scope, "a", {
		"data-slot": "field-group",
		class: cn("mu-field-group group/field-group @container/field-group flex w-full flex-col", $scope.e),
		...$scope.g
	});
