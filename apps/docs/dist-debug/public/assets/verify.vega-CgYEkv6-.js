...
_content_resume("Rzb3", "<p class=\"text-muted-foreground text-sm\">Change your password here. After saving, you'll be logged out.</p>");
_content_resume("Rzb2", "<p class=\"text-muted-foreground text-sm\">Make changes to your account here. Click save when you're done.</p>");
_content_resume("Rzb1", "Password");
_content_resume("Rzb0", "Account");
//#endregion
//#region src/tags/verify/vega/tabs/tabs-controlled.marko
var STATUS_TABS = [
	{
		value: "active",
		label: "Active"
...
var $Tabs_content$3 = _content_resume("Szb1", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$3);
...
_resume("Szb0", $valueChange);
//#endregion
//#region src/tags/verify/vega/tabs/tabs-demo.marko
...
_content_resume("Tzb0", "<!><!><!><!>", "b%b%", 0, $Tabs_content__$params$2);
//#endregion
//#region src/tags/verify/vega/tabs/tabs-disabled.marko
...
_content_resume("Uzb0", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$1);
_content_resume("Vzb1", "Tag Two");
_content_resume("Vzb0", "Tag One");
...
_content_resume("Vzb2", "Panel for <!>", "b%", 0, $Tabs_content__$params);
_content_resume("Wzb1", "Attr panel wins");
_content_resume("Wzb0", "Wins");
//#endregion
//#region dist-debug/.marko-run/verify.vega.tabs.client-entry.marko
init();
//#endregion
