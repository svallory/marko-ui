...
//#region src/tags/verify/mira/editable/controlled.marko
...
_resume("N21", $valueCommit);
_resume("N20", $valueChange);
//#endregion
//#region src/tags/verify/mira/editable/custom-trigger.marko
var $Button_content = /*@__PURE__*/ _content("O20", "Edit");
...
_content_resume("O21", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.mira.editable.client-entry.marko
init();
//#endregion
