...
//#region src/tags/verify/default/navigation-menu/controlled.marko
...
_script("jD1", ($scope) => _on($scope.c, "click", function() {
...
_resume("jD0", $valueChange);
_content_resume("mD1", "<div class=\"grid w-[400px] gap-1\"><a href=#button class=\"rounded-md p-2 text-sm hover:bg-accent\">Button</a><a href=#dialog class=\"rounded-md p-2 text-sm hover:bg-accent\">Dialog</a><a href=#tooltip class=\"rounded-md p-2 text-sm hover:bg-accent\">Tooltip</a></div>");
_content_resume("mD0", "<div class=\"grid w-[400px] gap-1\"><a href=#introduction class=\"rounded-md p-2 text-sm hover:bg-accent\">Introduction</a><a href=#installation class=\"rounded-md p-2 text-sm hover:bg-accent\">Installation</a><a href=#theming class=\"rounded-md p-2 text-sm hover:bg-accent\">Theming</a></div>");
//#endregion
//#region src/tags/verify/default/navigation-menu/panel.marko
...
_content_resume("oD0", "<!><!><!>", "b%", 0, $NavigationMenu_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.default.navigation-menu.client-entry.marko
init();
//#endregion
