...
_content_resume("YE3", "<p class=\"text-muted-foreground text-sm\">Change your password here. After saving, you'll be logged out.</p>");
_content_resume("YE2", "<p class=\"text-muted-foreground text-sm\">Make changes to your account here. Click save when you're done.</p>");
_content_resume("YE1", "Password");
_content_resume("YE0", "Account");
//#endregion
//#region src/tags/verify/default/tabs/tabs-controlled.marko
var STATUS_TABS = [
	{
		value: "active",
		label: "Active"
...
var $Tabs_content$3 = _content_resume("ZE1", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$3);
...
_resume("ZE0", $valueChange);
//#endregion
//#region src/tags/verify/default/tabs/tabs-demo.marko
...
_content_resume("$E0", "<!><!><!><!>", "b%b%", 0, $Tabs_content__$params$2);
//#endregion
//#region src/tags/verify/default/tabs/tabs-disabled.marko
...
_content_resume("aF0", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$1);
_content_resume("bF1", "Tag Two");
_content_resume("bF0", "Tag One");
...
_content_resume("bF2", "Panel for <!>", "b%", 0, $Tabs_content__$params);
_content_resume("cF1", "Attr panel wins");
_content_resume("cF0", "Wins");
//#endregion
//#region dist-debug/.marko-run/verify.default.tabs.client-entry.marko
init();
//#endregion
