...
//#region src/tags/verify/sera/editable/controlled.marko
...
_resume("Rob1", $valueCommit);
_resume("Rob0", $valueChange);
//#endregion
//#region src/tags/verify/sera/editable/custom-trigger.marko
var $Button_content = /*@__PURE__*/ _content("Sob0", "Edit");
...
_content_resume("Sob1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.sera.editable.client-entry.marko
init();
//#endregion
