...
//#region src/tags/verify/rhea/image-cropper/controlled.marko
...
_resume("hib1", $rotationChange);
_resume("hib0", $zoomChange);
//#endregion
//#region dist-debug/.marko-run/verify.rhea.image-cropper.client-entry.marko
init();
//#endregion
