import { E as _controllable_input, K as _return, M as _for_closure, N as _for_of, S as _const, U as _or, W as _resume, Z as _var_resume, _ as _attrs_script, g as _attrs_partial_content, h as _attrs_partial, n as _attr_class, p as _attrs, q as _script } from "./_CFDNqKnx.js";
import { t as cn } from "./_Dv2PW3if.js";
import "./_DAgwroWU.js";
import { B as last, I as first, a as createMachine, bt as createAnatomy, f as createSplitProps, ft as ariaAttr, j as isEqual, m as callAll, mt as dataAttr, n as $input$1, p as pick, t as $input$2 } from "./_ChYYrEpj.js";
import { i as raf } from "./_BJjj5X0-.js";
import { i as getEventPoint, m as isModifierKey, o as getEventStepValue, p as isLeftClick, r as getEventKey } from "./_x_hNpEYa.js";
...
import { _ as snapValueToStep, a as getPercentValue, c as getValueRanges, g as setValueAtIndex, i as getNextStepValue, l as getValueTransformer, n as clampValue, o as getPreviousStepValue, p as isValueWithinRange, s as getValuePercent, t as clampPercent, y as toPx } from "./_Dn7UoA6E2.js";
...
var parts = createAnatomy("slider").parts("root", "label", "thumb", "valueText", "track", "range", "control", "markerGroup", "marker", "draggingIndicator").build();
//#endregion
//#region ../../node_modules/.bun/@zag-js+slider@1.43.0/node_modules/@zag-js/slider/dist/slider.dom.mjs
...
var getPointValue = (params, point) => {
	...
	const percent = getRelativePointWithInset({
...
function getRelativePointWithInset(point, element, inset) {
	...
	return {
		offset,
		percent,
		getPercentValue: getPercentValue2
	};
}
...
//#endregion
//#region ../../node_modules/.bun/@zag-js+slider@1.43.0/node_modules/@zag-js/slider/dist/slider.style.mjs
...
function getThumbOffset(params, value) {
	const { prop } = params;
	return getOffset(params, getValuePercent(value, prop("min"), prop("max")) * 100, value);
}
...
//#endregion
//#region ../../node_modules/.bun/@zag-js+slider@1.43.0/node_modules/@zag-js/slider/dist/slider.utils.mjs
...
//#endregion
//#region ../../node_modules/.bun/@zag-js+slider@1.43.0/node_modules/@zag-js/slider/dist/slider.connect.mjs
function connect(service, normalize) {
	...
	return {
		...
		getMarkerProps(props) {
			...
			let markerState;
			if (props.value < first(sliderValue)) markerState = "under-value";
			else if (props.value > last(sliderValue)) markerState = "over-value";
...
//#endregion
//#region ../../node_modules/.bun/@zag-js+slider@1.43.0/node_modules/@zag-js/slider/dist/slider.machine.mjs
var isEqualSize = (a, b) => {
	return a?.width === b?.width && a?.height === b?.height;
};
var normalize = (value, min, max, step, minStepsBetweenThumbs) => {
	return getValueRanges(value, min, max, minStepsBetweenThumbs * step).map((range) => {
		...
		if (!isValueWithinRange(rangeValue, min, max)) throw new Error("[zag-js/slider] The configured `min`, `max`, `step` or `minStepsBetweenThumbs` values are invalid");
		return rangeValue;
	});
};
var machine = createMachine({
	...
	computed: {
		...
		valuePercent: memo(({ context, prop }) => [
			context.get("value"),
			prop("min"),
			prop("max")
...
//#endregion
//#region ../../node_modules/.bun/@zag-js+slider@1.43.0/node_modules/@zag-js/slider/dist/slider.props.mjs
...
createSplitProps(thumbProps);
var markerProps = createProps()(["value"]);
createSplitProps(markerProps);
//#endregion
//#region ../../packages/shadcn/ui/slider/slider.marko
var $for_content__api__script = _script("BWabmOD", ($scope) => {
	_attrs_script($scope, "a");
	_attrs_script($scope, "b");
});
var $for_content__api = /*@__PURE__*/ _for_closure(10, ($scope) => {
	_attrs($scope, "a", $scope._.q().getHiddenInputProps({ index: $scope.M }), _controllable_input);
	_attrs_partial_content($scope, "b", $scope._.q().getThumbProps({ index: $scope.M }), {
		"data-slot": 1,
		class: 1
	});
...
_var_resume("cKHF59U", ($scope, machineProps) => $input$1($scope.c, {
	machine: $machine,
	props: machineProps
}));
var $api__OR__nativeAttrs__script = _script("ptT6gh7", ($scope) => _attrs_script($scope, "g"));
...
_var_resume("z$W5N9C", ($scope, service) => $input$2($scope.e, {
	value: $api,
	service
}));
var $for = /*@__PURE__*/ _for_of(10, "<input><div data-slot=slider-thumb class=\"mu-slider-thumb block shrink-0 select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50\"></div>", " b ", $for_content__setup);
var $api2__script = _script("QRt3q5k", ($scope) => {
	_attrs_script($scope, "h");
	_attrs_script($scope, "i");
	_attrs_script($scope, "j");
});
_var_resume("G$aJMVo", /*@__PURE__*/ _const(16, ($scope) => {
	_attrs_partial($scope, "h", $scope.q().getControlProps(), {
		"data-slot": 1,
		class: 1
	});
	...
	$for($scope, [$scope.q().value]);
	$api__OR__nativeAttrs($scope);
	$for_content__api($scope);
	$api2__script($scope);
}));
var $input_class = ($scope, input_class) => _attr_class($scope.g, cn("mu-slider relative flex w-full touch-none items-center select-none data-[disabled]:opacity-50 data-[orientation=vertical]:h-full data-[orientation=vertical]:w-auto data-[orientation=vertical]:flex-col", input_class));
function $machine() {
	return machine;
}
function $nativeAttrs($scope) {
	return () => stripOwnProps(splitProps($scope.m)[1], "class", "valueChange");
}
function $onValueChange($scope) {
	return function(details) {
		$scope.m.onValueChange?.(details);
		$scope.m.valueChange?.(details.value);
	};
}
function $api(service, normalizeProps) {
	return connect(service, normalizeProps);
}
_resume("xNR2QxU", $machine);
_resume("BQ2IA7B", $nativeAttrs);
_resume("TlFFm4S", $onValueChange);
_resume("XaAWQii", $api);
//#endregion
export { $input as t };
