...
//#region src/tags/verify/mira/image-cropper/controlled.marko
...
_resume("w31", $rotationChange);
_resume("w30", $zoomChange);
//#endregion
//#region dist-debug/.marko-run/verify.mira.image-cropper.client-entry.marko
init();
//#endregion
