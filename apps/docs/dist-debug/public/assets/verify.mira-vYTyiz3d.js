...
_content_resume("a34", "or");
//#endregion
//#region src/tags/verify/mira/field/signup.marko
var $Button_content = /*@__PURE__*/ _content("f316", "Create account");
var $FieldDescription_content3 = /*@__PURE__*/ _content("f314", "At least 8 characters and one number.");
var $FieldLabel_content3 = /*@__PURE__*/ _content("f313", "Password");
var $FieldLabel_content2 = /*@__PURE__*/ _content("f311", "Email");
var $FieldDescription_content2 = /*@__PURE__*/ _content("f39", "3-20 characters: letters, numbers and underscores.");
var $FieldLabel_content = /*@__PURE__*/ _content("f38", "Username");
...
var $Field_content3 = /*@__PURE__*/ _content("f315", /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `<!>${_w0}${_w1}${_w2}${_w3}<!>`)($template$2, $template$4, $template$3, $template$5), /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `b/${_w0}&/${_w1}&/${_w2}&/${_w3}&b`)($walks$2, " b", $walks$3, "b%c"), $Field_content3__setup);
...
var $Field_content2 = /*@__PURE__*/ _content("f312", /*@__PURE__*/ ((_w0, _w1, _w2) => `<!>${_w0}${_w1}${_w2}<!>`)($template$2, $template$4, $template$5), /*@__PURE__*/ ((_w0, _w1, _w2) => `b/${_w0}&/${_w1}&/${_w2}&b`)($walks$2, " b", "b%c"), $Field_content2__setup);
...
var $Field_content = /*@__PURE__*/ _content("f310", /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `<!>${_w0}${_w1}${_w2}${_w3}<!>`)($template$2, $template$4, $template$3, $template$5), /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `b/${_w0}&/${_w1}&/${_w2}&/${_w3}&b`)($walks$2, " b", $walks$3, "b%c"), $Field_content__setup);
...
_content_resume("f317", /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `<!>${_w0}${_w1}${_w2}${_w3}<!><!>`)($template$1, $template$1, $template$1, $template), /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `b/${_w0}&/${_w1}&/${_w2}&/${_w3}&%c`)($walks$1, $walks$1, $walks$1, $walks), $FieldGroup_content__setup);
...
_script("f319", ($scope) => _on($scope.a, "submit", function(event, form) {
...
_resume("f34", $onBlur2);
_resume("f33", $onBlur);
_resume("f32", $validateForm);
_resume("f31", $validateField);
_resume("f30", $messageFor);
//#endregion
//#region dist-debug/.marko-run/verify.mira.field.client-entry.marko
init();
//#endregion
