...
_content_resume("k33", "<p class=text-muted-foreground>This panel cannot be resized below 260×180 or above 560×480.</p>");
_content_resume("k32", "Constrained");
var $Button_content$2 = /*@__PURE__*/ _content("k30", "Open constrained panel");
...
_content_resume("k31", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
//#endregion
//#region src/tags/verify/mira/floating-panel/floating-panel-controlled.marko
var $content_content$2 = _content_resume("l35", "<p class=text-muted-foreground>The button above owns this panel's open state, and the stage is mirrored back into the page.</p>");
var $title_content$2 = _content_resume("l34", "Controlled panel");
...
_resume("l32", $stageChange);
_resume("l31", $openChange);
_resume("l30", $onClick);
_content_resume("m33", "<p class=text-muted-foreground>Drag the header to move this panel. Grab any edge or corner to resize it. Use the header buttons to minimize, maximize or close.</p>");
_content_resume("m32", "Layers");
var $Button_content$1 = /*@__PURE__*/ _content("m30", "Open panel");
...
_content_resume("m31", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
_content_resume("n33", "<div class=\"grid gap-2\"><div class=\"flex items-center justify-between\"><span class=text-muted-foreground>Width</span><span class=font-medium>320px</span></div><div class=\"flex items-center justify-between\"><span class=text-muted-foreground>Resizable</span><span class=font-medium>No</span></div></div>");
_content_resume("n32", "Inspector");
var $Button_content = /*@__PURE__*/ _content("n30", "Open inspector");
...
_content_resume("n31", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.mira.floating-panel.client-entry.marko
init();
//#endregion
