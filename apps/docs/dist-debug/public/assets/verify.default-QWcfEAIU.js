...
import "./_DgRmQuzj.js";
_content_resume("jB2", "Edit");
var $Button_content$5 = /*@__PURE__*/ _content("jB0", "Actions");
...
_content_resume("jB1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$5, $trigger_content__$params$5);
//#endregion
//#region src/tags/verify/default/dropdown-menu/dropdown-menu-danger.marko
var $Button_content$4 = /*@__PURE__*/ _content("kB0", "Delete project");
...
_content_resume("kB1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$4, $trigger_content__$params$4);
//#endregion
//#region src/tags/verify/default/dropdown-menu/dropdown-menu-demo.marko
var $Button_content$3 = /*@__PURE__*/ _content("lB0", "Open");
...
_content_resume("lB1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$3, $trigger_content__$params$3);
//#endregion
//#region src/tags/verify/default/dropdown-menu/dropdown-menu-disabled-item.marko
var $Button_content$2 = /*@__PURE__*/ _content("mB0", "Edit");
...
_content_resume("mB1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
//#endregion
//#region src/tags/verify/default/dropdown-menu/dropdown-menu-selection.marko
var $Button_content$1 = /*@__PURE__*/ _content("nB1", "Open menu");
...
_content_resume("nB2", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
...
_resume("nB0", $select);
//#endregion
//#region src/tags/verify/default/dropdown-menu/dropdown-menu-simple.marko
var $Button_content = /*@__PURE__*/ _content("oB0", "Actions");
...
_content_resume("oB1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.default.dropdown-menu.client-entry.marko
init();
//#endregion
