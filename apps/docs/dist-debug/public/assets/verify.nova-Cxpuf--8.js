...
_content_resume("Ndb3", "<p class=\"text-muted-foreground text-sm\">Change your password here. After saving, you'll be logged out.</p>");
_content_resume("Ndb2", "<p class=\"text-muted-foreground text-sm\">Make changes to your account here. Click save when you're done.</p>");
_content_resume("Ndb1", "Password");
_content_resume("Ndb0", "Account");
//#endregion
//#region src/tags/verify/nova/tabs/tabs-controlled.marko
var STATUS_TABS = [
	{
		value: "active",
		label: "Active"
...
var $Tabs_content$3 = _content_resume("Odb1", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$3);
...
_resume("Odb0", $valueChange);
//#endregion
//#region src/tags/verify/nova/tabs/tabs-demo.marko
...
_content_resume("Pdb0", "<!><!><!><!>", "b%b%", 0, $Tabs_content__$params$2);
//#endregion
//#region src/tags/verify/nova/tabs/tabs-disabled.marko
...
_content_resume("Qdb0", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$1);
_content_resume("Rdb1", "Tag Two");
_content_resume("Rdb0", "Tag One");
...
_content_resume("Rdb2", "Panel for <!>", "b%", 0, $Tabs_content__$params);
_content_resume("Sdb1", "Attr panel wins");
_content_resume("Sdb0", "Wins");
//#endregion
//#region dist-debug/.marko-run/verify.nova.tabs.client-entry.marko
init();
//#endregion
