...
//#region ../../packages/shadcn/ui/card/footer.marko
var $template = "<div><!></div>";
var $walks = " D%l";
var $setup = () => {};
var $content_direct = /*@__PURE__*/ _dynamic_tag_content(1);
var $input_class__OR__rest__script = _script("i69lhlN", ($scope) => _attrs_script($scope, "a"));
var $input_class__OR__rest = /*@__PURE__*/ _or(7, ($scope) => {
	_attrs($scope, "a", {
		"data-slot": "card-footer",
		class: cn("mu-card-footer flex items-center", $scope.e),
		...$scope.g
	});
