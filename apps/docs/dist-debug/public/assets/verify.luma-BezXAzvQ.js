...
//#region src/tags/verify/luma/tour/controlled.marko
var STEPS = [{
	id: "controlled-one",
	title: "First",
...
var $Button_content$2 = /*@__PURE__*/ _content("jN2", "Start controlled tour");
...
var $trigger_content$2 = _content_resume("jN3", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
...
_resume("jN1", $statusChange);
_resume("jN0", $stepIdChange);
//#endregion
//#region src/tags/verify/luma/tour/default.marko
var $Button_content$1 = /*@__PURE__*/ _content("kN0", "Start tour");
...
_content_resume("kN1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
//#endregion
//#region src/tags/verify/luma/tour/sides.marko
var $Button_content = /*@__PURE__*/ _content("lN0", "Start short tour");
...
_content_resume("lN1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.luma.tour.client-entry.marko
init();
//#endregion
