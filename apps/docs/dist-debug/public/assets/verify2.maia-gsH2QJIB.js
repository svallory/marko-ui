...
//#region src/tags/verify/maia/tour/controlled.marko
var STEPS = [{
	id: "controlled-one",
	title: "First",
...
var $Button_content$2 = /*@__PURE__*/ _content("V_2", "Start controlled tour");
...
var $trigger_content$2 = _content_resume("V_3", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
...
_resume("V_1", $statusChange);
_resume("V_0", $stepIdChange);
//#endregion
//#region src/tags/verify/maia/tour/default.marko
var $Button_content$1 = /*@__PURE__*/ _content("W_0", "Start tour");
...
_content_resume("W_1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
//#endregion
//#region src/tags/verify/maia/tour/sides.marko
var $Button_content = /*@__PURE__*/ _content("X_0", "Start short tour");
...
_content_resume("X_1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.maia.tour.client-entry.marko
init();
//#endregion
