...
//#region src/tags/verify/vega/sheet/sheet-controlled.marko
var $description_content$2 = _content_resume("izb4", "This sheet's open state is held in the parent and can be toggled from outside too.");
var $title_content$2 = _content_resume("izb3", "Controlled sheet");
var $Button_content$2 = /*@__PURE__*/ _content("izb1", "Open controlled sheet");
...
var $trigger_content$2 = _content_resume("izb2", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
...
_resume("izb0", $openChange);
//#endregion
//#region src/tags/verify/vega/sheet/sheet-demo.marko
var $Label_content2 = /*@__PURE__*/ _content("jzb2", "Username");
var $Label_content = /*@__PURE__*/ _content("jzb1", "Name");
...
_content_resume("jzb6", /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `<div class="grid gap-4"><div class="grid gap-2">${_w0}${_w1}</div><div class="grid gap-2">${_w2}${_w3}</div></div>`)($template$1, $template$2, $template$1, $template$2), /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `E/${_w0}&/${_w1}&lD/${_w2}&/${_w3}&m`)($walks$1, " b", $walks$1, " b"), $content_content__setup);
_content_resume("jzb5", "Make changes to your profile here. Click save when you're done.");
_content_resume("jzb4", "Edit profile");
var $Button_content$1 = /*@__PURE__*/ _content("jzb0", "Open");
...
_content_resume("jzb3", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
_content_resume("kzb15", "Slides in from the left edge of the screen.");
_content_resume("kzb14", "Left sheet");
var $Button_content4 = /*@__PURE__*/ _content("kzb12", "Left");
...
_content_resume("kzb13", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content4__setup, $trigger_content4__$params);
_content_resume("kzb11", "Slides in from the bottom edge of the screen.");
_content_resume("kzb10", "Bottom sheet");
var $Button_content3 = /*@__PURE__*/ _content("kzb8", "Bottom");
...
_content_resume("kzb9", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content3__setup, $trigger_content3__$params);
_content_resume("kzb7", "Slides in from the right edge of the screen.");
_content_resume("kzb6", "Right sheet");
var $Button_content2 = /*@__PURE__*/ _content("kzb4", "Right");
...
_content_resume("kzb5", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content2__setup, $trigger_content2__$params);
_content_resume("kzb3", "Slides in from the top edge of the screen.");
_content_resume("kzb2", "Top sheet");
var $Button_content = /*@__PURE__*/ _content("kzb0", "Top");
...
_content_resume("kzb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.vega.sheet.client-entry.marko
init();
//#endregion
