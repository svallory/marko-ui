...
_content_resume("JT3", "<p class=\"text-muted-foreground text-sm\">Change your password here. After saving, you'll be logged out.</p>");
_content_resume("JT2", "<p class=\"text-muted-foreground text-sm\">Make changes to your account here. Click save when you're done.</p>");
_content_resume("JT1", "Password");
_content_resume("JT0", "Account");
//#endregion
//#region src/tags/verify/lyra/tabs/tabs-controlled.marko
var STATUS_TABS = [
	{
		value: "active",
		label: "Active"
...
var $Tabs_content$3 = _content_resume("KT1", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$3);
...
_resume("KT0", $valueChange);
//#endregion
//#region src/tags/verify/lyra/tabs/tabs-demo.marko
...
_content_resume("LT0", "<!><!><!><!>", "b%b%", 0, $Tabs_content__$params$2);
//#endregion
//#region src/tags/verify/lyra/tabs/tabs-disabled.marko
...
_content_resume("MT0", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$1);
_content_resume("NT1", "Tag Two");
_content_resume("NT0", "Tag One");
...
_content_resume("NT2", "Panel for <!>", "b%", 0, $Tabs_content__$params);
_content_resume("OT1", "Attr panel wins");
_content_resume("OT0", "Wins");
//#endregion
//#region dist-debug/.marko-run/verify.lyra.tabs.client-entry.marko
init();
//#endregion
