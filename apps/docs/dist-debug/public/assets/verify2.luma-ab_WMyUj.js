...
//#region src/tags/verify/luma/tooltip/tooltip-delay.marko
var $Button_content$2 = /*@__PURE__*/ _content("gN0", "No delay");
...
_content_resume("gN1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
//#endregion
//#region src/tags/verify/luma/tooltip/tooltip-demo.marko
var $Button_content$1 = /*@__PURE__*/ _content("hN0", "Hover me");
...
_content_resume("hN1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
//#endregion
//#region src/tags/verify/luma/tooltip/tooltip-positioning.marko
var $Button_content4 = /*@__PURE__*/ _content("iN6", "Left");
...
_content_resume("iN7", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content4__setup, $trigger_content4__$params);
var $Button_content3 = /*@__PURE__*/ _content("iN4", "Bottom");
...
_content_resume("iN5", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content3__setup, $trigger_content3__$params);
var $Button_content2 = /*@__PURE__*/ _content("iN2", "Right");
...
_content_resume("iN3", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content2__setup, $trigger_content2__$params);
var $Button_content = /*@__PURE__*/ _content("iN0", "Top");
...
_content_resume("iN1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.luma.tooltip.client-entry.marko
init();
//#endregion
