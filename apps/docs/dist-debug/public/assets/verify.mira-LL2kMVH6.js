...
//#region src/tags/verify/mira/steps/steps-controlled.marko
...
var $completedContent_content$3 = _content_resume("k62", "<p class=\"text-muted-foreground text-sm\">Order complete.</p>");
...
var $content_content$3 = _content_resume("k61", "<p class=\"text-muted-foreground text-sm\"><!> step content.</p>", "D%", 0, $content_content__$params$3);
...
_resume("k60", $stepChange);
//#endregion
//#region src/tags/verify/mira/steps/steps-horizontal.marko
var WIZARD_STEPS$1 = [
	{
		title: "Account",
...
_content_resume("l61", "<p class=\"text-muted-foreground text-sm\">All steps complete — thanks!</p>");
...
_content_resume("l60", "<p class=\"text-muted-foreground text-sm\">Step <!>: <!> content goes here.</p>", "Db%c%", 0, $content_content__$params$2);
//#endregion
//#region src/tags/verify/mira/steps/steps-linear.marko
var WIZARD_STEPS = [
	{
		title: "Account",
		description: "Provide your account details"
...
_content_resume("m61", "<p class=\"text-muted-foreground text-sm\">All steps complete — thanks!</p>");
...
_content_resume("m60", "<p class=\"text-muted-foreground text-sm\">Step <!>: <!> content goes here.</p>", "Db%c%", 0, $content_content__$params$1);
//#endregion
//#region src/tags/verify/mira/steps/steps-vertical.marko
var SHIPPING_STEPS = [
	{ title: "Cart" },
	{ title: "Shipping" },
	{ title: "Payment" },
...
_content_resume("n61", "<p class=\"text-muted-foreground text-sm\">Order complete.</p>");
...
_content_resume("n60", "<p class=\"text-muted-foreground text-sm\"><!> step content.</p>", "D%", 0, $content_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.mira.steps.client-entry.marko
init();
//#endregion
