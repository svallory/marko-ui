...
_content_resume("tab4", "or");
//#endregion
//#region src/tags/verify/nova/field/signup.marko
var $Button_content = /*@__PURE__*/ _content("yab16", "Create account");
var $FieldDescription_content3 = /*@__PURE__*/ _content("yab14", "At least 8 characters and one number.");
var $FieldLabel_content3 = /*@__PURE__*/ _content("yab13", "Password");
var $FieldLabel_content2 = /*@__PURE__*/ _content("yab11", "Email");
var $FieldDescription_content2 = /*@__PURE__*/ _content("yab9", "3-20 characters: letters, numbers and underscores.");
var $FieldLabel_content = /*@__PURE__*/ _content("yab8", "Username");
...
var $Field_content3 = /*@__PURE__*/ _content("yab15", /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `<!>${_w0}${_w1}${_w2}${_w3}<!>`)($template$2, $template$4, $template$3, $template$5), /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `b/${_w0}&/${_w1}&/${_w2}&/${_w3}&b`)($walks$2, " b", $walks$3, "b%c"), $Field_content3__setup);
...
var $Field_content2 = /*@__PURE__*/ _content("yab12", /*@__PURE__*/ ((_w0, _w1, _w2) => `<!>${_w0}${_w1}${_w2}<!>`)($template$2, $template$4, $template$5), /*@__PURE__*/ ((_w0, _w1, _w2) => `b/${_w0}&/${_w1}&/${_w2}&b`)($walks$2, " b", "b%c"), $Field_content2__setup);
...
var $Field_content = /*@__PURE__*/ _content("yab10", /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `<!>${_w0}${_w1}${_w2}${_w3}<!>`)($template$2, $template$4, $template$3, $template$5), /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `b/${_w0}&/${_w1}&/${_w2}&/${_w3}&b`)($walks$2, " b", $walks$3, "b%c"), $Field_content__setup);
...
_content_resume("yab17", /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `<!>${_w0}${_w1}${_w2}${_w3}<!><!>`)($template$1, $template$1, $template$1, $template), /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `b/${_w0}&/${_w1}&/${_w2}&/${_w3}&%c`)($walks$1, $walks$1, $walks$1, $walks), $FieldGroup_content__setup);
...
_script("yab19", ($scope) => _on($scope.a, "submit", function(event, form) {
...
_resume("yab5", $onBlur3);
_resume("yab4", $onBlur2);
_resume("yab3", $onBlur);
_resume("yab2", $validateForm);
_resume("yab1", $validateField);
_resume("yab0", $messageFor);
//#endregion
//#region dist-debug/.marko-run/verify.nova.field.client-entry.marko
init();
//#endregion
