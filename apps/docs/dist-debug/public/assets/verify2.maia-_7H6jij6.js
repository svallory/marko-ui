...
_script("x_0", ($scope) => _on($scope.a, "click", function() {
	toast.message({ title: "Event has been created" });
}));
_script("y_0", ($scope) => _on($scope.a, "click", function() {
...
//#endregion
//#region src/tags/verify/maia/toast/toast-promise.marko
function fetchData() {
	return new Promise((resolve) => {
		setTimeout(() => resolve({ name: "Toast" }), 2e3);
	});
}
_script("A_0", ($scope) => _on($scope.a, "click", function() {
...
//#endregion
//#region dist-debug/.marko-run/verify.maia.toast.client-entry.marko
init();
//#endregion
