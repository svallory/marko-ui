...
//#region src/tags/verify/luma/editable/controlled.marko
...
_resume("JI1", $valueCommit);
_resume("JI0", $valueChange);
//#endregion
//#region src/tags/verify/luma/editable/custom-trigger.marko
var $Button_content = /*@__PURE__*/ _content("KI0", "Edit");
...
_content_resume("KI1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.luma.editable.client-entry.marko
init();
//#endregion
