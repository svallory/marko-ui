...
//#region src/tags/verify/nova/alert-dialog/alert-dialog-controlled.marko
var $description_content$2 = _content_resume("E74", "The open state is controlled by the parent component.");
var $title_content$2 = _content_resume("E73", "Controlled alert dialog");
var $Button_content__open = /*@__PURE__*/ _closure_get(3, ($scope) => _text($scope.a, $scope._._.c ? "Close" : "Open"), ($scope) => $scope._._);
var $Button_content$2 = /*@__PURE__*/ _content("E71", " ", " ", $Button_content__open);
...
var $trigger_content$2 = _content_resume("E72", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
...
_resume("E70", $openChange);
_content_resume("F73", "This action cannot be undone. This will permanently delete your account and remove your data from our servers.");
_content_resume("F72", "Are you absolutely sure?");
var $Button_content$1 = /*@__PURE__*/ _content("F70", "Show Dialog");
...
_content_resume("F71", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
_content_resume("G74", "This will permanently delete your account. This action is irreversible.");
_content_resume("G73", "Delete account");
var $Button_content = /*@__PURE__*/ _content("G71", "Delete account");
...
_content_resume("G72", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
function $action() {
	console.log("deleted");
}
_resume("G70", $action);
//#endregion
//#region dist-debug/.marko-run/verify.nova.alert-dialog.client-entry.marko
init();
//#endregion
