import { Q as getDocument, X as contains, Z as getActiveElement, it as isDocument } from "./_ChYYrEpj.js";
import { i as raf } from "./_BJjj5X0-.js";
import { a as isControlledByExpandedController, i as hasControllerElements, o as isControlledElement, r as getControlledElements } from "./_BasvuOb7.js";
import { s as getEventTarget, t as addDomEvent } from "./_x_hNpEYa.js";
import { a as isFocusable, i as getTabbables, n as getTabIndex, o as isTabbable, t as getFocusables } from "./_BgIiQzs4.js";
//#region ../../node_modules/.bun/@zag-js+focus-trap@1.43.0/node_modules/@zag-js/focus-trap/dist/chunk-QZ7TP4HQ.mjs
...
//#endregion
//#region ../../node_modules/.bun/@zag-js+focus-trap@1.43.0/node_modules/@zag-js/focus-trap/dist/focus-trap.mjs
	...
	constructor(elements, options) {
		...
		__publicField(this, "findNextNavNode", (opts) => {
			...
			if (this.state.tabbableGroups.length > 0) {
				...
				if (containerIndex < 0) {
					if (isBackward) destinationNode = this.state.tabbableGroups[this.state.tabbableGroups.length - 1].lastTabbableNode;
...
//#endregion
//#region ../../node_modules/.bun/@zag-js+focus-trap@1.43.0/node_modules/@zag-js/focus-trap/dist/index.mjs
