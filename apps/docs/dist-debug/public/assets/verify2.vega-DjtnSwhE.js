...
import "./_DgRmQuzj.js";
_content_resume("cwb2", "Edit");
var $Button_content$5 = /*@__PURE__*/ _content("cwb0", "Actions");
...
_content_resume("cwb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$5, $trigger_content__$params$5);
//#endregion
//#region src/tags/verify/vega/dropdown-menu/dropdown-menu-danger.marko
var $Button_content$4 = /*@__PURE__*/ _content("dwb0", "Delete project");
...
_content_resume("dwb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$4, $trigger_content__$params$4);
//#endregion
//#region src/tags/verify/vega/dropdown-menu/dropdown-menu-demo.marko
var $Button_content$3 = /*@__PURE__*/ _content("ewb0", "Open");
...
_content_resume("ewb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$3, $trigger_content__$params$3);
//#endregion
//#region src/tags/verify/vega/dropdown-menu/dropdown-menu-disabled-item.marko
var $Button_content$2 = /*@__PURE__*/ _content("fwb0", "Edit");
...
_content_resume("fwb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
//#endregion
//#region src/tags/verify/vega/dropdown-menu/dropdown-menu-selection.marko
var $Button_content$1 = /*@__PURE__*/ _content("gwb1", "Open menu");
...
_content_resume("gwb2", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
...
_resume("gwb0", $select);
//#endregion
//#region src/tags/verify/vega/dropdown-menu/dropdown-menu-simple.marko
var $Button_content = /*@__PURE__*/ _content("hwb0", "Actions");
...
_content_resume("hwb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.vega.dropdown-menu.client-entry.marko
init();
//#endregion
