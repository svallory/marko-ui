...
//#region ../../node_modules/.bun/@zag-js+collection@1.43.0/node_modules/@zag-js/collection/dist/list-collection.mjs
var fallback = {
	itemToValue(item) {
		...
		*/
		__publicField(this, "search", (queryString, options) => {
			...
			function update(value2) {
				...
				cleanup();
				if (value2 !== "") state.timer = +setTimeout(() => {
					update("");
					cleanup();
				}, timeout);
			}
...
//#endregion
//#region ../../node_modules/.bun/@zag-js+collection@1.43.0/node_modules/@zag-js/collection/dist/selection-map.mjs
...
//#endregion
export { ListCollection as i, deriveSelectionState as n, resolveSelectedItems as r, createSelectedItemMap as t };
