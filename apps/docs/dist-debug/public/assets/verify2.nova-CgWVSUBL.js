...
//#region src/tags/verify/nova/tree-view/controlled-selection.marko
var FILE_TREE = [
	{
		id: "src",
		label: "src",
...
_resume("Jeb0", $selectedValueChange);
//#endregion
//#region dist-debug/.marko-run/verify.nova.tree-view.client-entry.marko
init();
//#endregion
