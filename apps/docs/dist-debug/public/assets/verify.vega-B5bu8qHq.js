...
//#region src/tags/verify/vega/sidebar/sidebar-controlled.marko
...
_content_resume("lzb12", /*@__PURE__*/ ((_w0) => `<div class="flex min-w-0 flex-1 flex-col"><header class="flex h-12 items-center gap-2 border-b px-3">${_w0}</header><main class="flex-1 overflow-auto p-4 text-sm text-muted-foreground">This sidebar's open state is owned by the demo page.</main></div>`)($template$6), /*@__PURE__*/ ((_w0) => `E/${_w0}&m`)("b%c"), $content_content2__setup$1, $content_content2__$params$1);
var $SidebarMenuButton_content2 = /*@__PURE__*/ _content("lzb5", "Profile");
...
var $SidebarMenuItem_content2 = /*@__PURE__*/ _content("lzb6", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)("b%c"), $SidebarMenuItem_content2__setup);
var $SidebarMenuButton_content$1 = /*@__PURE__*/ _content("lzb3", "Home");
...
var $SidebarMenuItem_content$1 = /*@__PURE__*/ _content("lzb4", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)("b%c"), $SidebarMenuItem_content__setup$1);
...
var $SidebarMenu_content$1 = /*@__PURE__*/ _content("lzb7", /*@__PURE__*/ ((_w0, _w1) => `<!>${_w0}${_w1}<!>`)($template$1, $template$1), /*@__PURE__*/ ((_w0, _w1) => `b/${_w0}&/${_w1}&b`)($walks, $walks), $SidebarMenu_content__setup$1);
var $SidebarGroupLabel_content$1 = /*@__PURE__*/ _content("lzb2", "Menu");
...
var $SidebarGroup_content$1 = /*@__PURE__*/ _content("lzb8", /*@__PURE__*/ ((_w0, _w1) => `<!>${_w0}${_w1}<!>`)($template$9, $template$2), /*@__PURE__*/ ((_w0, _w1) => `b/${_w0}&/${_w1}&b`)($walks$6, $walks$1), $SidebarGroup_content__setup$1);
...
var $SidebarContent_content$1 = /*@__PURE__*/ _content("lzb9", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template$3), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks$2), $SidebarContent_content__setup$1);
var $SidebarHeader_content$1 = /*@__PURE__*/ _content("lzb1", "<div class=\"px-2 text-sm font-semibold\">Controlled</div>");
...
var $content_content$1 = _content_resume("lzb10", /*@__PURE__*/ ((_w0, _w1) => `<!>${_w0}${_w1}<!>`)($template$7, $template$4), /*@__PURE__*/ ((_w0, _w1) => `b/${_w0}&/${_w1}&b`)($walks$4, $walks$3), $content_content__setup$1);
...
_content_resume("lzb11", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template$5), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)("b%c"), $sidebar_content__setup$1, $sidebar_content__$params$1);
var $open = /*@__PURE__*/ _let(3, ($scope) => {
	_text($scope.a, $scope.d);
	$input_open($scope.b, $scope.d);
});
_script("lzb13", ($scope) => _on($scope.c, "click", function() {
	$open($scope, !$scope.d);
}));
...
_resume("lzb0", $openChange);
//#endregion
//#region src/tags/verify/vega/sidebar/sidebar-demo.marko
var NAV_ITEMS = [
	{
		title: "Inbox",
		href: "#",
...
_content_resume("mzb10", /*@__PURE__*/ ((_w0) => `<div class="flex min-w-0 flex-1 flex-col"><header class="flex h-12 items-center gap-2 border-b px-3">${_w0}<span class="text-sm text-muted-foreground">Sidebar is <!></span></header><main class="flex-1 overflow-auto p-4 text-sm text-muted-foreground">Main content area. Click the trigger to collapse the sidebar.</main></div>`)($template$6), /*@__PURE__*/ ((_w0) => `E/${_w0}&Db%n`)("b%c"), $content_content2__setup, $content_content2__$params);
var $SidebarFooter_content = /*@__PURE__*/ _content("mzb7", "<div class=\"px-2 text-xs text-sidebar-foreground/70\">v1.0.0</div>");
var $SidebarMenuButton_content = /*@__PURE__*/ _content("mzb2", " ", " ", /* @__PURE__ */ _closure_get(8, ($scope) => _text($scope.a, $scope._._.f), ($scope) => $scope._._));
...
var $SidebarMenuItem_content = /*@__PURE__*/ _content("mzb3", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)("b%c"), $SidebarMenuItem_content__setup);
...
var $SidebarMenu_content = /*@__PURE__*/ _content("mzb4", "<!><!><!>", "b%", $SidebarMenu_content__setup);
var $SidebarGroupLabel_content = /*@__PURE__*/ _content("mzb1", "Platform");
...
var $SidebarGroup_content = /*@__PURE__*/ _content("mzb5", /*@__PURE__*/ ((_w0, _w1) => `<!>${_w0}${_w1}<!>`)($template$9, $template$2), /*@__PURE__*/ ((_w0, _w1) => `b/${_w0}&/${_w1}&b`)($walks$6, $walks$1), $SidebarGroup_content__setup);
...
var $SidebarContent_content = /*@__PURE__*/ _content("mzb6", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template$3), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks$2), $SidebarContent_content__setup);
var $SidebarHeader_content = /*@__PURE__*/ _content("mzb0", "<div class=\"flex items-center gap-2 px-2 text-sm font-semibold\">Acme Inc</div>");
...
var $content_content = _content_resume("mzb8", /*@__PURE__*/ ((_w0, _w1, _w2) => `<!>${_w0}${_w1}${_w2}<!>`)($template$7, $template$4, $template$8), /*@__PURE__*/ ((_w0, _w1, _w2) => `b/${_w0}&/${_w1}&/${_w2}&b`)($walks$4, $walks$3, $walks$5), $content_content__setup);
...
_content_resume("mzb9", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template$5), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)("b%c"), $sidebar_content__setup, $sidebar_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.vega.sidebar.client-entry.marko
init();
//#endregion
