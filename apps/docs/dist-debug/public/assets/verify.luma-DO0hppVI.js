...
_content_resume("qM3", "<p class=\"text-muted-foreground text-sm\">Change your password here. After saving, you'll be logged out.</p>");
_content_resume("qM2", "<p class=\"text-muted-foreground text-sm\">Make changes to your account here. Click save when you're done.</p>");
_content_resume("qM1", "Password");
_content_resume("qM0", "Account");
//#endregion
//#region src/tags/verify/luma/tabs/tabs-controlled.marko
var STATUS_TABS = [
	{
		value: "active",
		label: "Active"
...
var $Tabs_content$3 = _content_resume("rM1", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$3);
...
_resume("rM0", $valueChange);
//#endregion
//#region src/tags/verify/luma/tabs/tabs-demo.marko
...
_content_resume("sM0", "<!><!><!><!>", "b%b%", 0, $Tabs_content__$params$2);
//#endregion
//#region src/tags/verify/luma/tabs/tabs-disabled.marko
...
_content_resume("tM0", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$1);
_content_resume("uM1", "Tag Two");
_content_resume("uM0", "Tag One");
...
_content_resume("uM2", "Panel for <!>", "b%", 0, $Tabs_content__$params);
_content_resume("vM1", "Attr panel wins");
_content_resume("vM0", "Wins");
//#endregion
//#region dist-debug/.marko-run/verify.luma.tabs.client-entry.marko
init();
//#endregion
