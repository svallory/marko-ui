...
//#region src/tags/verify/maia/tooltip/tooltip-delay.marko
var $Button_content$2 = /*@__PURE__*/ _content("S_0", "No delay");
...
_content_resume("S_1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
//#endregion
//#region src/tags/verify/maia/tooltip/tooltip-demo.marko
var $Button_content$1 = /*@__PURE__*/ _content("T_0", "Hover me");
...
_content_resume("T_1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
//#endregion
//#region src/tags/verify/maia/tooltip/tooltip-positioning.marko
var $Button_content4 = /*@__PURE__*/ _content("U_6", "Left");
...
_content_resume("U_7", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content4__setup, $trigger_content4__$params);
var $Button_content3 = /*@__PURE__*/ _content("U_4", "Bottom");
...
_content_resume("U_5", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content3__setup, $trigger_content3__$params);
var $Button_content2 = /*@__PURE__*/ _content("U_2", "Right");
...
_content_resume("U_3", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content2__setup, $trigger_content2__$params);
var $Button_content = /*@__PURE__*/ _content("U_0", "Top");
...
_content_resume("U_1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.maia.tooltip.client-entry.marko
init();
//#endregion
