...
//#region src/tags/verify/rhea/alert-dialog/alert-dialog-controlled.marko
var $description_content$2 = _content_resume("Xeb4", "The open state is controlled by the parent component.");
var $title_content$2 = _content_resume("Xeb3", "Controlled alert dialog");
var $Button_content__open = /*@__PURE__*/ _closure_get(3, ($scope) => _text($scope.a, $scope._._.c ? "Close" : "Open"), ($scope) => $scope._._);
var $Button_content$2 = /*@__PURE__*/ _content("Xeb1", " ", " ", $Button_content__open);
...
var $trigger_content$2 = _content_resume("Xeb2", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
...
_resume("Xeb0", $openChange);
_content_resume("Yeb3", "This action cannot be undone. This will permanently delete your account and remove your data from our servers.");
_content_resume("Yeb2", "Are you absolutely sure?");
var $Button_content$1 = /*@__PURE__*/ _content("Yeb0", "Show Dialog");
...
_content_resume("Yeb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
_content_resume("Zeb4", "This will permanently delete your account. This action is irreversible.");
_content_resume("Zeb3", "Delete account");
var $Button_content = /*@__PURE__*/ _content("Zeb1", "Delete account");
...
_content_resume("Zeb2", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
function $action() {
	console.log("deleted");
}
_resume("Zeb0", $action);
//#endregion
//#region dist-debug/.marko-run/verify.rhea.alert-dialog.client-entry.marko
init();
//#endregion
