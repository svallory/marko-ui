...
//#region ../../packages/shadcn/ui/kbd/group.marko
var $template = "<kbd></kbd><!><!>";
var $walks = " b%c";
var $setup = () => {};
var $input_class__OR__rest__script = _script("VRc$dBn", ($scope) => _attrs_script($scope, "a"));
var $input_class__OR__rest = /*@__PURE__*/ _or(7, ($scope) => {
	_attrs_content($scope, "a", {
		"data-slot": "kbd-group",
		class: cn("mu-kbd-group inline-flex items-center", $scope.f),
		...$scope.g
	});
