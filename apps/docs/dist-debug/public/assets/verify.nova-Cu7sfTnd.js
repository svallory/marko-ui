...
_content_resume("Dab3", "<p class=text-muted-foreground>This panel cannot be resized below 260×180 or above 560×480.</p>");
_content_resume("Dab2", "Constrained");
var $Button_content$2 = /*@__PURE__*/ _content("Dab0", "Open constrained panel");
...
_content_resume("Dab1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
//#endregion
//#region src/tags/verify/nova/floating-panel/floating-panel-controlled.marko
var $content_content$2 = _content_resume("Eab5", "<p class=text-muted-foreground>The button above owns this panel's open state, and the stage is mirrored back into the page.</p>");
var $title_content$2 = _content_resume("Eab4", "Controlled panel");
...
_resume("Eab2", $stageChange);
_resume("Eab1", $openChange);
_resume("Eab0", $onClick);
_content_resume("Fab3", "<p class=text-muted-foreground>Drag the header to move this panel. Grab any edge or corner to resize it. Use the header buttons to minimize, maximize or close.</p>");
_content_resume("Fab2", "Layers");
var $Button_content$1 = /*@__PURE__*/ _content("Fab0", "Open panel");
...
_content_resume("Fab1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
_content_resume("Gab3", "<div class=\"grid gap-2\"><div class=\"flex items-center justify-between\"><span class=text-muted-foreground>Width</span><span class=font-medium>320px</span></div><div class=\"flex items-center justify-between\"><span class=text-muted-foreground>Resizable</span><span class=font-medium>No</span></div></div>");
_content_resume("Gab2", "Inspector");
var $Button_content = /*@__PURE__*/ _content("Gab0", "Open inspector");
...
_content_resume("Gab1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.nova.floating-panel.client-entry.marko
init();
//#endregion
