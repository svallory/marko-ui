...
//#region src/tags/verify/rhea/popover/popover-controlled.marko
var $content_content$2 = _content_resume("Kjb3", "<p class=text-sm>Controlled popover content.</p>");
var $Button_content__open = /*@__PURE__*/ _closure_get(3, ($scope) => _text($scope.a, $scope._._.c ? "Close" : "Open"), ($scope) => $scope._._);
var $Button_content$2 = /*@__PURE__*/ _content("Kjb1", " ", " ", $Button_content__open);
...
var $trigger_content$2 = _content_resume("Kjb2", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
...
_resume("Kjb0", $openChange);
_content_resume("Ljb2", "<div class=\"grid gap-2\"><h4 class=\"leading-none font-medium\">Dimensions</h4><p class=\"text-muted-foreground text-sm\">Set the dimensions for the layer.</p></div>");
var $Button_content$1 = /*@__PURE__*/ _content("Ljb0", "Open popover");
...
_content_resume("Ljb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
_content_resume("Mjb2", "<p class=text-sm>Positioned to the right of the trigger.</p>");
var $Button_content = /*@__PURE__*/ _content("Mjb0", "Right start");
...
_content_resume("Mjb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.rhea.popover.client-entry.marko
init();
//#endregion
