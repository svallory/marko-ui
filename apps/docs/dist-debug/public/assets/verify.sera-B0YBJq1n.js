...
_script("Usb0", ($scope) => _on($scope.a, "click", function() {
	toast.message({ title: "Event has been created" });
}));
_script("Vsb0", ($scope) => _on($scope.a, "click", function() {
...
//#endregion
//#region src/tags/verify/sera/toast/toast-promise.marko
function fetchData() {
	return new Promise((resolve) => {
		setTimeout(() => resolve({ name: "Toast" }), 2e3);
	});
}
_script("Xsb0", ($scope) => _on($scope.a, "click", function() {
...
//#endregion
//#region dist-debug/.marko-run/verify.sera.toast.client-entry.marko
init();
//#endregion
