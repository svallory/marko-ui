...
_content_resume("ysb3", "<p class=\"text-muted-foreground text-sm\">Change your password here. After saving, you'll be logged out.</p>");
_content_resume("ysb2", "<p class=\"text-muted-foreground text-sm\">Make changes to your account here. Click save when you're done.</p>");
_content_resume("ysb1", "Password");
_content_resume("ysb0", "Account");
//#endregion
//#region src/tags/verify/sera/tabs/tabs-controlled.marko
var STATUS_TABS = [
	{
		value: "active",
		label: "Active"
...
var $Tabs_content$3 = _content_resume("zsb1", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$3);
...
_resume("zsb0", $valueChange);
//#endregion
//#region src/tags/verify/sera/tabs/tabs-demo.marko
...
_content_resume("Asb0", "<!><!><!><!>", "b%b%", 0, $Tabs_content__$params$2);
//#endregion
//#region src/tags/verify/sera/tabs/tabs-disabled.marko
...
_content_resume("Bsb0", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$1);
_content_resume("Csb1", "Tag Two");
_content_resume("Csb0", "Tag One");
...
_content_resume("Csb2", "Panel for <!>", "b%", 0, $Tabs_content__$params);
_content_resume("Dsb1", "Attr panel wins");
_content_resume("Dsb0", "Wins");
//#endregion
//#region dist-debug/.marko-run/verify.sera.tabs.client-entry.marko
init();
//#endregion
