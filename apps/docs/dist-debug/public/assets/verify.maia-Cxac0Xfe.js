...
//#region src/tags/verify/maia/steps/steps-controlled.marko
...
var $completedContent_content$3 = _content_resume("S$2", "<p class=\"text-muted-foreground text-sm\">Order complete.</p>");
...
var $content_content$3 = _content_resume("S$1", "<p class=\"text-muted-foreground text-sm\"><!> step content.</p>", "D%", 0, $content_content__$params$3);
...
_resume("S$0", $stepChange);
//#endregion
//#region src/tags/verify/maia/steps/steps-horizontal.marko
var WIZARD_STEPS$1 = [
	{
		title: "Account",
...
_content_resume("T$1", "<p class=\"text-muted-foreground text-sm\">All steps complete — thanks!</p>");
...
_content_resume("T$0", "<p class=\"text-muted-foreground text-sm\">Step <!>: <!> content goes here.</p>", "Db%c%", 0, $content_content__$params$2);
//#endregion
//#region src/tags/verify/maia/steps/steps-linear.marko
var WIZARD_STEPS = [
	{
		title: "Account",
		description: "Provide your account details"
...
_content_resume("U$1", "<p class=\"text-muted-foreground text-sm\">All steps complete — thanks!</p>");
...
_content_resume("U$0", "<p class=\"text-muted-foreground text-sm\">Step <!>: <!> content goes here.</p>", "Db%c%", 0, $content_content__$params$1);
//#endregion
//#region src/tags/verify/maia/steps/steps-vertical.marko
var SHIPPING_STEPS = [
	{ title: "Cart" },
	{ title: "Shipping" },
	{ title: "Payment" },
...
_content_resume("V$1", "<p class=\"text-muted-foreground text-sm\">Order complete.</p>");
...
_content_resume("V$0", "<p class=\"text-muted-foreground text-sm\"><!> step content.</p>", "D%", 0, $content_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.maia.steps.client-entry.marko
init();
//#endregion
