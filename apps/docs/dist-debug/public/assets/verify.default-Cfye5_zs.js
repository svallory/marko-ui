...
//#region src/tags/verify/default/resizable/resizable-controlled.marko
...
_content_resume("$D1", "<div class=\"flex h-full items-center justify-center p-6\"><span class=font-semibold> </span></div>", "E ", 0, $content_content__$params$3);
...
_resume("$D0", $resizeChange);
//#endregion
//#region src/tags/verify/default/resizable/resizable-demo.marko
var INNER_PANELS = [{
	id: "two-a",
	defaultSize: 25
}, {
...
var $content_content2 = _content_resume("aE0", "<div class=\"flex h-full items-center justify-center p-6\"><span class=font-semibold> </span></div>", "E ", 0, $content_content2__$params);
...
_content_resume("aE1", "<!><!><!>", "b%", 0, $content_content__$params$2);
//#endregion
//#region src/tags/verify/default/resizable/resizable-sizes.marko
...
_content_resume("bE0", "<div class=\"flex h-full items-center justify-center p-6\"><span class=font-semibold> </span></div>", "E ", 0, $content_content__$params$1);
//#endregion
//#region src/tags/verify/default/resizable/resizable-vertical.marko
...
_content_resume("cE0", "<div class=\"flex h-full items-center justify-center p-6\"><span class=font-semibold> </span></div>", "E ", 0, $content_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.default.resizable.client-entry.marko
init();
//#endregion
