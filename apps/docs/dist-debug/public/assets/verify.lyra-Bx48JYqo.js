...
//#region src/tags/verify/lyra/tour/controlled.marko
var STEPS = [{
	id: "controlled-one",
	title: "First",
...
var $Button_content$2 = /*@__PURE__*/ _content("CU2", "Start controlled tour");
...
var $trigger_content$2 = _content_resume("CU3", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
...
_resume("CU1", $statusChange);
_resume("CU0", $stepIdChange);
//#endregion
//#region src/tags/verify/lyra/tour/default.marko
var $Button_content$1 = /*@__PURE__*/ _content("DU0", "Start tour");
...
_content_resume("DU1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
//#endregion
//#region src/tags/verify/lyra/tour/sides.marko
var $Button_content = /*@__PURE__*/ _content("EU0", "Start short tour");
...
_content_resume("EU1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.lyra.tour.client-entry.marko
init();
//#endregion
