...
//#region src/tags/verify/rhea/steps/steps-controlled.marko
...
var $completedContent_content$3 = _content_resume("Wkb2", "<p class=\"text-muted-foreground text-sm\">Order complete.</p>");
...
var $content_content$3 = _content_resume("Wkb1", "<p class=\"text-muted-foreground text-sm\"><!> step content.</p>", "D%", 0, $content_content__$params$3);
...
_resume("Wkb0", $stepChange);
//#endregion
//#region src/tags/verify/rhea/steps/steps-horizontal.marko
var WIZARD_STEPS$1 = [
	{
		title: "Account",
...
_content_resume("Xkb1", "<p class=\"text-muted-foreground text-sm\">All steps complete — thanks!</p>");
...
_content_resume("Xkb0", "<p class=\"text-muted-foreground text-sm\">Step <!>: <!> content goes here.</p>", "Db%c%", 0, $content_content__$params$2);
//#endregion
//#region src/tags/verify/rhea/steps/steps-linear.marko
var WIZARD_STEPS = [
	{
		title: "Account",
		description: "Provide your account details"
...
_content_resume("Ykb1", "<p class=\"text-muted-foreground text-sm\">All steps complete — thanks!</p>");
...
_content_resume("Ykb0", "<p class=\"text-muted-foreground text-sm\">Step <!>: <!> content goes here.</p>", "Db%c%", 0, $content_content__$params$1);
//#endregion
//#region src/tags/verify/rhea/steps/steps-vertical.marko
var SHIPPING_STEPS = [
	{ title: "Cart" },
	{ title: "Shipping" },
	{ title: "Payment" },
...
_content_resume("Zkb1", "<p class=\"text-muted-foreground text-sm\">Order complete.</p>");
...
_content_resume("Zkb0", "<p class=\"text-muted-foreground text-sm\"><!> step content.</p>", "D%", 0, $content_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.rhea.steps.client-entry.marko
init();
//#endregion
