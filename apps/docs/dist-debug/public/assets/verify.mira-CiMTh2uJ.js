...
_content_resume("u63", "<p class=\"text-muted-foreground text-sm\">Change your password here. After saving, you'll be logged out.</p>");
_content_resume("u62", "<p class=\"text-muted-foreground text-sm\">Make changes to your account here. Click save when you're done.</p>");
_content_resume("u61", "Password");
_content_resume("u60", "Account");
//#endregion
//#region src/tags/verify/mira/tabs/tabs-controlled.marko
var STATUS_TABS = [
	{
		value: "active",
		label: "Active"
...
var $Tabs_content$3 = _content_resume("v61", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$3);
...
_resume("v60", $valueChange);
//#endregion
//#region src/tags/verify/mira/tabs/tabs-demo.marko
...
_content_resume("w60", "<!><!><!><!>", "b%b%", 0, $Tabs_content__$params$2);
//#endregion
//#region src/tags/verify/mira/tabs/tabs-disabled.marko
...
_content_resume("x60", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$1);
_content_resume("y61", "Tag Two");
_content_resume("y60", "Tag One");
...
_content_resume("y62", "Panel for <!>", "b%", 0, $Tabs_content__$params);
_content_resume("z61", "Attr panel wins");
_content_resume("z60", "Wins");
//#endregion
//#region dist-debug/.marko-run/verify.mira.tabs.client-entry.marko
init();
//#endregion
