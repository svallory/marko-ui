...
_script("MM0", ($scope) => _on($scope.a, "click", function() {
	toast.message({ title: "Event has been created" });
}));
_script("NM0", ($scope) => _on($scope.a, "click", function() {
...
//#endregion
//#region src/tags/verify/luma/toast/toast-promise.marko
function fetchData() {
	return new Promise((resolve) => {
		setTimeout(() => resolve({ name: "Toast" }), 2e3);
	});
}
_script("PM0", ($scope) => _on($scope.a, "click", function() {
...
//#endregion
//#region dist-debug/.marko-run/verify.luma.toast.client-entry.marko
init();
//#endregion
