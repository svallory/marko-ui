...
//#region src/tags/verify/vega/tour/controlled.marko
var STEPS = [{
	id: "controlled-one",
	title: "First",
...
var $Button_content$2 = /*@__PURE__*/ _content("KAb2", "Start controlled tour");
...
var $trigger_content$2 = _content_resume("KAb3", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
...
_resume("KAb1", $statusChange);
_resume("KAb0", $stepIdChange);
//#endregion
//#region src/tags/verify/vega/tour/default.marko
var $Button_content$1 = /*@__PURE__*/ _content("LAb0", "Start tour");
...
_content_resume("LAb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
//#endregion
//#region src/tags/verify/vega/tour/sides.marko
var $Button_content = /*@__PURE__*/ _content("MAb0", "Start short tour");
...
_content_resume("MAb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.vega.tour.client-entry.marko
init();
//#endregion
