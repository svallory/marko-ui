...
_script("ieb0", ($scope) => _on($scope.a, "click", function() {
	toast.message({ title: "Event has been created" });
}));
_script("jeb0", ($scope) => _on($scope.a, "click", function() {
...
//#endregion
//#region src/tags/verify/nova/toast/toast-promise.marko
function fetchData() {
	return new Promise((resolve) => {
		setTimeout(() => resolve({ name: "Toast" }), 2e3);
	});
}
_script("leb0", ($scope) => _on($scope.a, "click", function() {
...
//#endregion
//#region dist-debug/.marko-run/verify.nova.toast.client-entry.marko
init();
//#endregion
