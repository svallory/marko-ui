...
_script("tF0", ($scope) => _on($scope.a, "click", function() {
	toast.message({ title: "Event has been created" });
}));
_script("uF0", ($scope) => _on($scope.a, "click", function() {
...
//#endregion
//#region src/tags/verify/default/toast/toast-promise.marko
function fetchData() {
	return new Promise((resolve) => {
		setTimeout(() => resolve({ name: "Toast" }), 2e3);
	});
}
_script("wF0", ($scope) => _on($scope.a, "click", function() {
...
//#endregion
//#region dist-debug/.marko-run/verify.default.toast.client-entry.marko
init();
//#endregion
