...
//#region src/tags/verify/sera/steps/steps-controlled.marko
...
var $completedContent_content$3 = _content_resume("osb2", "<p class=\"text-muted-foreground text-sm\">Order complete.</p>");
...
var $content_content$3 = _content_resume("osb1", "<p class=\"text-muted-foreground text-sm\"><!> step content.</p>", "D%", 0, $content_content__$params$3);
...
_resume("osb0", $stepChange);
//#endregion
//#region src/tags/verify/sera/steps/steps-horizontal.marko
var WIZARD_STEPS$1 = [
	{
		title: "Account",
...
_content_resume("psb1", "<p class=\"text-muted-foreground text-sm\">All steps complete — thanks!</p>");
...
_content_resume("psb0", "<p class=\"text-muted-foreground text-sm\">Step <!>: <!> content goes here.</p>", "Db%c%", 0, $content_content__$params$2);
//#endregion
//#region src/tags/verify/sera/steps/steps-linear.marko
var WIZARD_STEPS = [
	{
		title: "Account",
		description: "Provide your account details"
...
_content_resume("qsb1", "<p class=\"text-muted-foreground text-sm\">All steps complete — thanks!</p>");
...
_content_resume("qsb0", "<p class=\"text-muted-foreground text-sm\">Step <!>: <!> content goes here.</p>", "Db%c%", 0, $content_content__$params$1);
//#endregion
//#region src/tags/verify/sera/steps/steps-vertical.marko
var SHIPPING_STEPS = [
	{ title: "Cart" },
	{ title: "Shipping" },
	{ title: "Payment" },
...
_content_resume("rsb1", "<p class=\"text-muted-foreground text-sm\">Order complete.</p>");
...
_content_resume("rsb0", "<p class=\"text-muted-foreground text-sm\"><!> step content.</p>", "D%", 0, $content_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.sera.steps.client-entry.marko
init();
//#endregion
