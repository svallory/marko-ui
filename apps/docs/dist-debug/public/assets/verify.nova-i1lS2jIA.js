...
//#region src/tags/verify/nova/tour/controlled.marko
var STEPS = [{
	id: "controlled-one",
	title: "First",
...
var $Button_content$2 = /*@__PURE__*/ _content("Geb2", "Start controlled tour");
...
var $trigger_content$2 = _content_resume("Geb3", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
...
_resume("Geb1", $statusChange);
_resume("Geb0", $stepIdChange);
//#endregion
//#region src/tags/verify/nova/tour/default.marko
var $Button_content$1 = /*@__PURE__*/ _content("Heb0", "Start tour");
...
_content_resume("Heb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
//#endregion
//#region src/tags/verify/nova/tour/sides.marko
var $Button_content = /*@__PURE__*/ _content("Ieb0", "Start short tour");
...
_content_resume("Ieb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.nova.tour.client-entry.marko
init();
//#endregion
