...
//#region src/tags/verify/default/tooltip/tooltip-delay.marko
var $Button_content$2 = /*@__PURE__*/ _content("OF0", "No delay");
...
_content_resume("OF1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
//#endregion
//#region src/tags/verify/default/tooltip/tooltip-demo.marko
var $Button_content$1 = /*@__PURE__*/ _content("PF0", "Hover me");
...
_content_resume("PF1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
//#endregion
//#region src/tags/verify/default/tooltip/tooltip-positioning.marko
var $Button_content4 = /*@__PURE__*/ _content("QF6", "Left");
...
_content_resume("QF7", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content4__setup, $trigger_content4__$params);
var $Button_content3 = /*@__PURE__*/ _content("QF4", "Bottom");
...
_content_resume("QF5", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content3__setup, $trigger_content3__$params);
var $Button_content2 = /*@__PURE__*/ _content("QF2", "Right");
...
_content_resume("QF3", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content2__setup, $trigger_content2__$params);
var $Button_content = /*@__PURE__*/ _content("QF0", "Top");
...
_content_resume("QF1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.default.tooltip.client-entry.marko
init();
//#endregion
