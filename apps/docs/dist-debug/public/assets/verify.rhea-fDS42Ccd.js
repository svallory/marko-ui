...
_content_resume("flb3", "<p class=\"text-muted-foreground text-sm\">Change your password here. After saving, you'll be logged out.</p>");
_content_resume("flb2", "<p class=\"text-muted-foreground text-sm\">Make changes to your account here. Click save when you're done.</p>");
_content_resume("flb1", "Password");
_content_resume("flb0", "Account");
//#endregion
//#region src/tags/verify/rhea/tabs/tabs-controlled.marko
var STATUS_TABS = [
	{
		value: "active",
		label: "Active"
...
var $Tabs_content$3 = _content_resume("glb1", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$3);
...
_resume("glb0", $valueChange);
//#endregion
//#region src/tags/verify/rhea/tabs/tabs-demo.marko
...
_content_resume("hlb0", "<!><!><!><!>", "b%b%", 0, $Tabs_content__$params$2);
//#endregion
//#region src/tags/verify/rhea/tabs/tabs-disabled.marko
...
_content_resume("ilb0", "<p class=\"text-muted-foreground text-sm\">Showing <!> items.</p>", "Db%", 0, $Tabs_content__$params$1);
_content_resume("jlb1", "Tag Two");
_content_resume("jlb0", "Tag One");
...
_content_resume("jlb2", "Panel for <!>", "b%", 0, $Tabs_content__$params);
_content_resume("klb1", "Attr panel wins");
_content_resume("klb0", "Wins");
//#endregion
//#region dist-debug/.marko-run/verify.rhea.tabs.client-entry.marko
init();
//#endregion
