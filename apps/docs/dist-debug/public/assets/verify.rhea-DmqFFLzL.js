...
import "./_DgRmQuzj.js";
_content_resume("rhb2", "Edit");
var $Button_content$5 = /*@__PURE__*/ _content("rhb0", "Actions");
...
_content_resume("rhb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$5, $trigger_content__$params$5);
//#endregion
//#region src/tags/verify/rhea/dropdown-menu/dropdown-menu-danger.marko
var $Button_content$4 = /*@__PURE__*/ _content("shb0", "Delete project");
...
_content_resume("shb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$4, $trigger_content__$params$4);
//#endregion
//#region src/tags/verify/rhea/dropdown-menu/dropdown-menu-demo.marko
var $Button_content$3 = /*@__PURE__*/ _content("thb0", "Open");
...
_content_resume("thb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$3, $trigger_content__$params$3);
//#endregion
//#region src/tags/verify/rhea/dropdown-menu/dropdown-menu-disabled-item.marko
var $Button_content$2 = /*@__PURE__*/ _content("uhb0", "Edit");
...
_content_resume("uhb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
//#endregion
//#region src/tags/verify/rhea/dropdown-menu/dropdown-menu-selection.marko
var $Button_content$1 = /*@__PURE__*/ _content("vhb1", "Open menu");
...
_content_resume("vhb2", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
...
_resume("vhb0", $select);
//#endregion
//#region src/tags/verify/rhea/dropdown-menu/dropdown-menu-simple.marko
var $Button_content = /*@__PURE__*/ _content("whb0", "Actions");
...
_content_resume("whb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.rhea.dropdown-menu.client-entry.marko
init();
//#endregion
