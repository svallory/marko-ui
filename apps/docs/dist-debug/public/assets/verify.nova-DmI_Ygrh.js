...
//#region src/tags/verify/nova/sheet/sheet-controlled.marko
var $description_content$2 = _content_resume("edb4", "This sheet's open state is held in the parent and can be toggled from outside too.");
var $title_content$2 = _content_resume("edb3", "Controlled sheet");
var $Button_content$2 = /*@__PURE__*/ _content("edb1", "Open controlled sheet");
...
var $trigger_content$2 = _content_resume("edb2", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
...
_resume("edb0", $openChange);
//#endregion
//#region src/tags/verify/nova/sheet/sheet-demo.marko
var $Label_content2 = /*@__PURE__*/ _content("fdb2", "Username");
var $Label_content = /*@__PURE__*/ _content("fdb1", "Name");
...
_content_resume("fdb6", /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `<div class="grid gap-4"><div class="grid gap-2">${_w0}${_w1}</div><div class="grid gap-2">${_w2}${_w3}</div></div>`)($template$1, $template$2, $template$1, $template$2), /*@__PURE__*/ ((_w0, _w1, _w2, _w3) => `E/${_w0}&/${_w1}&lD/${_w2}&/${_w3}&m`)($walks$1, " b", $walks$1, " b"), $content_content__setup);
_content_resume("fdb5", "Make changes to your profile here. Click save when you're done.");
_content_resume("fdb4", "Edit profile");
var $Button_content$1 = /*@__PURE__*/ _content("fdb0", "Open");
...
_content_resume("fdb3", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
_content_resume("gdb15", "Slides in from the left edge of the screen.");
_content_resume("gdb14", "Left sheet");
var $Button_content4 = /*@__PURE__*/ _content("gdb12", "Left");
...
_content_resume("gdb13", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content4__setup, $trigger_content4__$params);
_content_resume("gdb11", "Slides in from the bottom edge of the screen.");
_content_resume("gdb10", "Bottom sheet");
var $Button_content3 = /*@__PURE__*/ _content("gdb8", "Bottom");
...
_content_resume("gdb9", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content3__setup, $trigger_content3__$params);
_content_resume("gdb7", "Slides in from the right edge of the screen.");
_content_resume("gdb6", "Right sheet");
var $Button_content2 = /*@__PURE__*/ _content("gdb4", "Right");
...
_content_resume("gdb5", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content2__setup, $trigger_content2__$params);
_content_resume("gdb3", "Slides in from the top edge of the screen.");
_content_resume("gdb2", "Top sheet");
var $Button_content = /*@__PURE__*/ _content("gdb0", "Top");
...
_content_resume("gdb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.nova.sheet.client-entry.marko
init();
//#endregion
