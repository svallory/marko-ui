...
//#region src/tags/verify/rhea/tooltip/tooltip-delay.marko
var $Button_content$2 = /*@__PURE__*/ _content("Wlb0", "No delay");
...
_content_resume("Wlb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$2, $trigger_content__$params$2);
//#endregion
//#region src/tags/verify/rhea/tooltip/tooltip-demo.marko
var $Button_content$1 = /*@__PURE__*/ _content("Xlb0", "Hover me");
...
_content_resume("Xlb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup$1, $trigger_content__$params$1);
//#endregion
//#region src/tags/verify/rhea/tooltip/tooltip-positioning.marko
var $Button_content4 = /*@__PURE__*/ _content("Ylb6", "Left");
...
_content_resume("Ylb7", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content4__setup, $trigger_content4__$params);
var $Button_content3 = /*@__PURE__*/ _content("Ylb4", "Bottom");
...
_content_resume("Ylb5", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content3__setup, $trigger_content3__$params);
var $Button_content2 = /*@__PURE__*/ _content("Ylb2", "Right");
...
_content_resume("Ylb3", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content2__setup, $trigger_content2__$params);
var $Button_content = /*@__PURE__*/ _content("Ylb0", "Top");
...
_content_resume("Ylb1", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $trigger_content__setup, $trigger_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.rhea.tooltip.client-entry.marko
init();
//#endregion
