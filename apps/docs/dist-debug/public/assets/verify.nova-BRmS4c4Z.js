...
//#region src/tags/verify/nova/steps/steps-controlled.marko
...
var $completedContent_content$3 = _content_resume("Ddb2", "<p class=\"text-muted-foreground text-sm\">Order complete.</p>");
...
var $content_content$3 = _content_resume("Ddb1", "<p class=\"text-muted-foreground text-sm\"><!> step content.</p>", "D%", 0, $content_content__$params$3);
...
_resume("Ddb0", $stepChange);
//#endregion
//#region src/tags/verify/nova/steps/steps-horizontal.marko
var WIZARD_STEPS$1 = [
	{
		title: "Account",
...
_content_resume("Edb1", "<p class=\"text-muted-foreground text-sm\">All steps complete — thanks!</p>");
...
_content_resume("Edb0", "<p class=\"text-muted-foreground text-sm\">Step <!>: <!> content goes here.</p>", "Db%c%", 0, $content_content__$params$2);
//#endregion
//#region src/tags/verify/nova/steps/steps-linear.marko
var WIZARD_STEPS = [
	{
		title: "Account",
		description: "Provide your account details"
...
_content_resume("Fdb1", "<p class=\"text-muted-foreground text-sm\">All steps complete — thanks!</p>");
...
_content_resume("Fdb0", "<p class=\"text-muted-foreground text-sm\">Step <!>: <!> content goes here.</p>", "Db%c%", 0, $content_content__$params$1);
//#endregion
//#region src/tags/verify/nova/steps/steps-vertical.marko
var SHIPPING_STEPS = [
	{ title: "Cart" },
	{ title: "Shipping" },
	{ title: "Payment" },
...
_content_resume("Gdb1", "<p class=\"text-muted-foreground text-sm\">Order complete.</p>");
...
_content_resume("Gdb0", "<p class=\"text-muted-foreground text-sm\"><!> step content.</p>", "D%", 0, $content_content__$params);
//#endregion
//#region dist-debug/.marko-run/verify.nova.steps.client-entry.marko
init();
//#endregion
