...
//#region src/tags/verify/luma/image-cropper/controlled.marko
...
_resume("sJ1", $rotationChange);
_resume("sJ0", $zoomChange);
//#endregion
//#region dist-debug/.marko-run/verify.luma.image-cropper.client-entry.marko
init();
//#endregion
