...
import "./_Cov2JroK.js";
//#region src/tags/verify/nova/scroll-area/default.marko
...
_content_resume("Tcb0", "<div class=p-4><h4 class=\"mb-4 text-sm leading-none font-medium\">Tags</h4><!></div>", "Db%", $ScrollArea_content__setup$1);
//#endregion
//#region src/tags/verify/nova/scroll-area/horizontal.marko
...
_content_resume("Ucb0", "<div class=\"flex w-max space-x-4 p-4\"></div>", " ", $ScrollArea_content__setup);
//#endregion
//#region dist-debug/.marko-run/verify.nova.scroll-area.client-entry.marko
init();
//#endregion
