...
// Ported verbatim from shadcn styles/base-nova/ui/sheet.tsx: the base-nova
...
// base-nova parity: class strings match shadcn/ui's base-nova implementation exactly.
const base =
