...
//
// Byte-identical duplicate of ../../../default/ui/chart/math.ts. This file
// has zero visual/class content (pure geometry helpers) and there is no
// existing precedent in packages/registry/styles/rhea/ for a rhea component
// importing non-visual helper logic back from packages/registry/default/
// (checked: no rhea/ui/**/*.{ts,marko} file imports across the default/
// boundary) — every rhea dir is a self-contained copy. Duplicating here
// keeps navigation-menu/chart consistent with that established pattern
// instead of introducing a new cross-theme import convention.
