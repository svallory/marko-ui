/**
 * Generates per-library icon maps for packages/shadcn/ui/icon/.
 *
...
// for every packages/shadcn/ui/<name>/ dir — no subdirectories),
// so generated files sit directly under ui/icon/ rather than a lib/ subdir.
const OUT_DIR = join(ROOT, "ui/icon");
const MAPPING_PATH = join(ROOT, "ui/icon/icon-mapping.json");
